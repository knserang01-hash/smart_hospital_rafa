...
#Title
st.set_page_config(page_title="Smart Hospital Patient Navigator Rafa")
...
DEPT_INFO = {
    'Respiratory Medicine': {
        'icon':'🫁','color':"#103447",'bg':"#95aab8",'border':'#7dd3fc',
    ...
    'Cardiology': {
        'icon':'❤️','color':"#A90E0E",'bg':"#da9d9d",'border':'#fca5a5',
    ...
    'Gastroenterology': {
        'icon':'🫃','color':"#ff8800",'bg':"#f9f3dc",'border':'#fcd34d',
    ...
    'Neurology': {
        'icon':'🧠','color':"#352256",'bg':"#9b8ae8",'border':'#c4b5fd',
        'desc':'i think it Specialises in brain, spine, and nervous system conditions.',
        'next':['Visit Level 4, Wing A','Estimated wait: 25–35 min','Bring list of current medications']
    },
    'General Medicine': {
        'icon':'🩺','color':"#31463F",'bg':"#5dce94",'border':'#6ee7b7',
    ...
    'Dermatology': {
        'icon':'🔬','color':"#e7ccb6",'bg':"#767352",'border':'#fde68a',
